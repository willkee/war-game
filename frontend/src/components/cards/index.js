		...
		<div>
			{loaded && (
				<>
					...
					<Player deck={self} />
					{/* button
            when the button is clicked, we fire off a function that makes the game play and updates the decks and wins
            */}
